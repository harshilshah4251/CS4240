// $ANTLR 3.5.2 Tiger.g 2014-11-04 03:56:08
...
public class TigerParser extends Parser {
	...
	public final TigerParser.funct_declaration_tail_return funct_declaration_tail(Token retType) throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: block_list, ID, FUNCTION, param_list
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
		...
		try {
			...
			switch (alt16) {
				...
				case 4 :
					...
					// AST REWRITE
					// elements: FOR, stat_seq, ID, index_expr, index_expr
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
		...
		try {
			...
			switch (alt17) {
				...
				case 2 :
					...
					// AST REWRITE
					// elements: ASSIGN, ID, value_tail, expr_or_function_call
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
