// $ANTLR 3.5.2 Tiger.g 2014-11-12 01:17:35
...
public class TigerLexer extends Lexer {
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:261:5: ( ( LOWER | UPPER ) ( LOWER | UPPER | DIGIT | '_' )* )
			// Tiger.g:261:9: ( LOWER | UPPER ) ( LOWER | UPPER | DIGIT | '_' )*
			{
			...
			// Tiger.g:261:22: ( LOWER | UPPER | DIGIT | '_' )*
			loop1:
			while (true) {
				int alt1=2;
	...
	public final void mCOMMENT() throws RecognitionException {
		try {
			int _type = COMMENT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:269:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// Tiger.g:269:9: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// Tiger.g:269:14: ( options {greedy=false; } : . )*
			loop3:
			while (true) {
				int alt3=2;
		...
		try {
			...
			switch (alt5) {
				case 1 :
					...
					break;
				case 2 :
					// Tiger.g:274:9: '1' .. '9' ( DIGIT )*
					{
					matchRange('1','9'); 
					// Tiger.g:274:18: ( DIGIT )*
					loop4:
					while (true) {
						int alt4=2;
	...
	public final void mFIXEDPTLIT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:278:5: ( INTLIT '.' ( DIGIT | DIGIT DIGIT | DIGIT DIGIT DIGIT ) )
			// Tiger.g:278:9: INTLIT '.' ( DIGIT | DIGIT DIGIT | DIGIT DIGIT DIGIT )
			{
			mINTLIT(); 

			match('.'); 
			// Tiger.g:278:20: ( DIGIT | DIGIT DIGIT | DIGIT DIGIT DIGIT )
			int alt6=3;
			...
			switch (alt6) {
				...
				case 2 :
					...
					break;
				case 3 :
					// Tiger.g:278:43: DIGIT DIGIT DIGIT
					{
					mDIGIT(); 
	...
	public final void mINVALID_INTLIT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:282:5: ( '0' ( DIGIT )+ )
			// Tiger.g:282:9: '0' ( DIGIT )+
			{
			match('0'); 
			// Tiger.g:282:13: ( DIGIT )+
			int cnt7=0;
			loop7:
			while (true) {
				int alt7=2;
	...
	public final void mINVALID_FIXEDPTLIT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:286:5: ( INVALID_INTLIT '.' ( DIGIT | DIGIT DIGIT | DIGIT DIGIT DIGIT )? | INTLIT '.' ( DIGIT DIGIT DIGIT ( DIGIT )+ )? )
			int alt11=2;
			...
			switch (alt11) {
				case 1 :
					// Tiger.g:286:9: INVALID_INTLIT '.' ( DIGIT | DIGIT DIGIT | DIGIT DIGIT DIGIT )?
					{
					mINVALID_INTLIT(); 

					match('.'); 
					// Tiger.g:286:28: ( DIGIT | DIGIT DIGIT | DIGIT DIGIT DIGIT )?
					int alt8=4;
					...
					switch (alt8) {
						...
						case 2 :
							...
							break;
						case 3 :
							// Tiger.g:286:51: DIGIT DIGIT DIGIT
							{
							mDIGIT(); 
					...
					break;
				case 2 :
					// Tiger.g:287:9: INTLIT '.' ( DIGIT DIGIT DIGIT ( DIGIT )+ )?
					{
					mINTLIT(); 

					match('.'); 
					// Tiger.g:287:20: ( DIGIT DIGIT DIGIT ( DIGIT )+ )?
					int alt10=2;
					...
					switch (alt10) {
						case 1 :
							// Tiger.g:287:21: DIGIT DIGIT DIGIT ( DIGIT )+
							{
							mDIGIT(); 
