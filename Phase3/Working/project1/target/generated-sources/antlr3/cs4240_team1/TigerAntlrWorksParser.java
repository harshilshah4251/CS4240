// $ANTLR 3.5.2 cs4240_team1/TigerAntlrWorks.g 2014-12-03 04:23:38
...
public class TigerAntlrWorksParser extends Parser {
	...
	public final TigerAntlrWorksParser.var_declaration_return var_declaration() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: type_id, VAR, id_list, optional_init
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
		...
		try {
			...
			switch (alt16) {
				...
				case 4 :
					...
					// AST REWRITE
					// elements: FOR, stat_seq, index_expr, ID, index_expr
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
