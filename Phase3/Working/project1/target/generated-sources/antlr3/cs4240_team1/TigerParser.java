// $ANTLR 3.5.2 cs4240_team1/Tiger.g 2014-12-05 17:29:55
...
public class TigerParser extends Parser {
	...
	public final TigerParser.funct_declaration_tail_return funct_declaration_tail(Token retType) throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: FUNCTION, param_list, block_list, ID
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
		...
		try {
			...
			switch (alt16) {
				...
				case 4 :
					...
					// AST REWRITE
					// elements: index_expr, FOR, ID, index_expr, stat_seq
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
		...
		try {
			...
			switch (alt17) {
				...
				case 2 :
					...
					// AST REWRITE
					// elements: ASSIGN, value_tail, ID, expr_or_function_call
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
